...
def main():
    ...
    save_rec_path = "./inference_results/rec_results/"
    ...
    for file in get_image_file_list(config['Global']['infer_img']):
        ...
        draw_img = draw_text_res(post_result, file)
        pure_img_name = os.path.split(file)[-1]
        cv2.imwrite(os.path.join(save_rec_path, "rec_res_%s" % pure_img_name), draw_img)
    logger.info("success!")
