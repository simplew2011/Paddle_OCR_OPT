...
model_urls = {
    ...
    'rec': {
        ...
        'en': {
            ...
            'dict_path': './ppocr/utils/dicts/en_dict.txt'
        },
        'french': {
            'url':
            'https://paddleocr.bj.bcebos.com/dygraph_v2.0/multilingual/french_mobile_v2.0_rec_infer.tar',
            'dict_path': './ppocr/utils/dicts/french_dict.txt'
        },
        'german': {
            'url':
            'https://paddleocr.bj.bcebos.com/dygraph_v2.0/multilingual/german_mobile_v2.0_rec_infer.tar',
            'dict_path': './ppocr/utils/dicts/german_dict.txt'
        },
        'korean': {
            'url':
            'https://paddleocr.bj.bcebos.com/dygraph_v2.0/multilingual/korean_mobile_v2.0_rec_infer.tar',
            'dict_path': './ppocr/utils/dicts/korean_dict.txt'
        },
        'japan': {
            'url':
            'https://paddleocr.bj.bcebos.com/dygraph_v2.0/multilingual/japan_mobile_v2.0_rec_infer.tar',
            'dict_path': './ppocr/utils/dicts/japan_dict.txt'
        }
    },
    'cls':
...
def parse_args(mMain=True, add_help=True):
    ...
    if mMain:
        ...
        return argparse.Namespace(
            ...
            use_tensorrt=False,
            gpu_mem=8000,
            image_dir=r'C:\Users\Administrator\Desktop\test\chepai',
            det_algorithm='DB',
            det_model_dir=None,
